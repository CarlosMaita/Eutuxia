...
<section>
  ...
  <form action="{{route('cotizacion.store')}}" method="POST">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" id="propuesta" name="propuesta" rows="4" required>{{old('propuesta')}}</textarea>
    </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control" id="incluye" name="incluye" rows="3">{{old('incluye')}}</textarea>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="no_incluye">Qué NO incluye</label>
          <textarea class="form-control" id="no_incluye" name="no_incluye" rows="3">{{old('no_incluye')}}</textarea>
        </div>
      </div>
    </div>
